      ...
      {!resume ? (
        <div 
          className={clsx(
            ...
            dragActive ? "border-teal-500 bg-teal-500/10" : "border-slate-700 bg-slate-900/50 hover:border-teal-400/50 hover:bg-slate-800/50"
          )}
        ...
        >
          ...
          {isUploading ? (
            <div className="flex flex-col items-center gap-4 py-4">
              ...
              <span className="text-sm font-medium text-teal-300">Extracting PDF magically...</span>
            </div>
          ) : (
        ...
        <div className="flex flex-col flex-1 min-h-0">
          <div className="flex-1 bg-slate-900/50 border border-slate-800 rounded-xl p-2 text-xs text-slate-400 overflow-hidden mb-4 relative flex flex-col">
            <div className="flex items-center justify-between gap-2 mb-2 pb-2 border-b border-slate-800/80 px-2 shrink-0">
              ...
              {resumeName && (
                <span className="text-[10px] text-teal-400 font-semibold truncate max-w-[170px] bg-teal-500/10 px-2.5 py-1 rounded-md border border-teal-500/20" title={resumeName}>
                  {resumeName}
                </span>
              )}
            </div>
